...
for (let i = 0; i < 10; i++) {
  const key = REF_TOP.slice(i * 3, i * 3 + 3) + REF_MID.slice(i * 3, i * 3 + 3) + REF_BOT.slice(i * 3, i * 3 + 3)
...
for (let i = 0; i < numDigits; i++) {
  const key = line1.slice(i * 3, i * 3 + 3) + line2.slice(i * 3, i * 3 + 3) + line3.slice(i * 3, i * 3 + 3)
