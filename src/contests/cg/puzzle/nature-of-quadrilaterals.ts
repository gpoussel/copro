...
for (let i = 0; i < n; i++) {
  ...
  function sq(x1: number, y1: number, x2: number, y2: number) {
    return (x2 - x1) ** 2 + (y2 - y1) ** 2
  }

  // Dot product of vectors (p1->p2) and (p3->p4)
  function dot(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number) {
    return (x2 - x1) * (x4 - x3) + (y2 - y1) * (y4 - y3)
  }

  // Cross product of vectors (p1->p2) and (p3->p4)
  function cross(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number) {
